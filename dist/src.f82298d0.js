...
},{"process":"g5I+"}],"w7+3":[function(require,module,exports) {
var define;
...
},{}],"s8eH":[function(require,module,exports) {
...
$(function () {
  var $abtn = $(".add-task-btn");
  var $cbtn = $(".clear-all-btn");
  var $Tinput = $(".T-text");
  var $Dinput = $(".description");
  var $container = $(".todo-tasked-container");
  var $datepicker = $("#datepicker");
  var $connected = $(".todo-container"); // 関数化すると楽！
  ...
  */
  ...
  var Pstore = JSON.parse(localStorage.getItem("TodoStore")) || [];
  var Istore = JSON.parse(localStorage.getItem("i-Store")) || [];
  var Cstore = JSON.parse(localStorage.getItem("c-Store")) || [];

  var task = function task(e) {
    return "\n  <div class=\"todo-item\"id=".concat(e.id, ">\n   <div class=\"contained-item\">\n    <div class=\"task-header\">").concat(e.text, "</div>\n    <div class=\"task-date\">").concat(e.date, "</div>\n    <div class=\"task-description\">").concat(e.element, "</div>\n   </div>\n   <input type=\"button\" value=\"\u2716\" class=\"del\" style=\"width:30px\">\n  </div>");
  };

  var renderList = function renderList() {
    console.log("4");
    var prevStoreIndex = $container.find(".todo-item").length;
    var prevStoreIndexI = $("#InProgress").find(".todo-item").length;
    var prevStoreIndexC = $("#Completed").find(".todo-item").length;
    Pstore.slice(prevStoreIndex).map(function (e, i) {
      $container.append(task(e));
    });
    Istore.slice(prevStoreIndexI).map(function (e, i) {
      $("#InProgress").append(task(e));
    });
    Cstore.slice(prevStoreIndexC).map(function (e, i) {
      $("#Completed").append(task(e));
    });
  };

  if (Pstore) {
    console.log(Pstore); // sortByDate(JSON.parse(localStorage.getItem("TodoStore")));
    // console.log(sortByDate);
  ...
  function sortableInit() {
    $("#Pending,#InProgress,#Completed").sortable({
  ...
  var filterStore = function filterStore(ui) {
    Pstore = Pstore.filter(function (item, index) {
      return item.id != ui.item.attr("id");
    });
    Cstore = Cstore.filter(function (item, index) {
      return item.id != ui.item.attr("id");
    });
    Istore = Istore.filter(function (item, index) {
      return item.id != ui.item.attr("id");
    });
  };

  var taskData = function taskData(ui) {
    return {
  ...
  $(document).on("click", ".del", function () {
    ...
    Pstore.map(function (item, index) {
      var item_id = item.id;
    ...
    Istore.map(function (item, index) {
      var item_id = item.id;
    ...
    Cstore.map(function (item, index) {
      var item_id = item.id;
...
},{"jquery":"HlZQ","jquery-ui-dist/jquery-ui.js":"w7+3","./index.css":"s8eH"}]},{},["H99C"], null)